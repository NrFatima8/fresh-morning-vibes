    ...
    <section id="location" className="py-24 bg-background">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <span className="text-fresh font-medium uppercase tracking-wider text-sm">Visit Us</span>
            ...
            <p className="text-muted-foreground leading-relaxed mb-8">
              Located in the heart of Faisalabad, Feelfresh is your perfect destination for a refreshing break.
              Whether you're starting your day or need an afternoon pick-me-up, we're here for you.
            </p>
              ...
              <Card className="border-0 shadow-md bg-card">
                <CardContent className="p-5 flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Open Daily — Come visit us anytime!</p>
                  </div>
                </CardContent>
              </Card>
              <Card className="border-0 shadow-md bg-card">
          ...
          >
            ...
            >
              ...
              <p className="text-primary-foreground/70 text-sm mt-1">Your daily dose of freshness</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
