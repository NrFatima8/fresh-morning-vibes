...
const FloatingDessert = ({ position, color, size = 0.5 }: { position: [number, number, number]; color: string; size?: number }) => {
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-xl mx-auto">
            These aren't just menu items—they're experiences. Our most loved 
            creations that keep guests coming back for more.
          </p>
        </motion.div>
