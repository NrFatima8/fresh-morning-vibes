  ...
  return (
    <section id="contact" className="py-24 bg-card">
      <div className="container mx-auto px-6">
        ...
        >
          <span className="text-fresh font-medium uppercase tracking-wider text-sm">Get in Touch</span>
              ...
              <div className="flex border-b border-border">
                <button
                  ...
                  className={`flex-1 py-4 px-6 font-medium transition-colors flex items-center justify-center gap-2 ${
                    activeTab === "order" ? "text-fresh border-b-2 border-fresh" : "text-muted-foreground hover:text-foreground"
                  }`}
                >
                  <ShoppingBag size={18} />
                  Order Online
                ...
                <button
                  ...
                  className={`flex-1 py-4 px-6 font-medium transition-colors flex items-center justify-center gap-2 ${
                    activeTab === "reservation" ? "text-fresh border-b-2 border-fresh" : "text-muted-foreground hover:text-foreground"
                  }`}
                >
                ...
                {activeTab === "order" ? (
                    ...
                    <form onSubmit={orderForm.handleSubmit(onOrderSubmit)} className="space-y-5">
                      ...
                      <FormField control={orderForm.control} name="phone" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl><Input placeholder="+92 XXX XXXXXXX" {...field} /></FormControl>
                          <FormMessage />
                        </FormItem>
                      )} />
                      <FormField control={orderForm.control} name="items" render={({ field }) => (
                        <FormItem>
                          ...
                          <FormControl>
                            <Textarea placeholder="Describe your order (e.g., 2x Brownie Cake, 1x Signature Latte...)" className="min-h-[120px]" {...field} />
                          </FormControl>
                          <FormMessage />
                        </FormItem>
                      )} />
                      <Button type="submit" disabled={isSubmitting} className="w-full bg-terracotta hover:bg-terracotta/90 text-terracotta-foreground rounded-full">
                        {isSubmitting ? (
                          <><Loader2 size={18} className="mr-2 animate-spin" />Sending...</>
                        ) : (
                          <><Send size={18} className="mr-2" />Submit Order</>
                        )}
                      </Button>
                    </form>
                  </Form>
                  ...
                  <Form {...reservationForm}>
                    <form onSubmit={reservationForm.handleSubmit(onReservationSubmit)} className="space-y-5">
                      <div className="grid md:grid-cols-2 gap-5">
                        <FormField control={reservationForm.control} name="name" render={({ field }) => (
                          <FormItem>
                            <FormLabel>Name</FormLabel>
                            <FormControl><Input placeholder="Your name" {...field} /></FormControl>
                            <FormMessage />
                        ...
                        <FormField control={reservationForm.control} name="email" render={({ field }) => (
                          <FormItem>
                            <FormLabel>Email</FormLabel>
                            <FormControl><Input type="email" placeholder="your@email.com" {...field} /></FormControl>
                            <FormMessage />
                      ...
                      <FormField control={reservationForm.control} name="phone" render={({ field }) => (
                        <FormItem>
                          <FormLabel>Phone Number</FormLabel>
                          <FormControl><Input placeholder="+92 XXX XXXXXXX" {...field} /></FormControl>
                          <FormMessage />
                      ...
                      <div className="grid md:grid-cols-2 gap-5">
                        <FormField control={reservationForm.control} name="time" render={({ field }) => (
                          <FormItem>
                        ...
                        <FormField control={reservationForm.control} name="guests" render={({ field }) => (
                          <FormItem>
          ...
          >
            ...
            <Card className="border-0 shadow-xl bg-background">
              ...
              <CardContent className="flex gap-4">
                <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-400 flex items-center justify-center text-white hover:scale-110 transition-transform">
                  <Instagram size={24} />
                </a>
                <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-foreground flex items-center justify-center text-background hover:scale-110 transition-transform">
                  <Music2 size={24} />
                </a>
              </CardContent>
            </Card>
