...
const FloatingPastry = ({ position, color }) => {
  ...
  return (
    <Float speed={1.5} rotationIntensity={1} floatIntensity={2}>
      <mesh ref={meshRef} position={position}>
        ...
        <MeshDistortMaterial color={color} speed={2} distort={0.3} roughness={0.4} />
      </mesh>
    </Float>
  );
};
...
const Particles = () => {
  ...
  return (
    <points ref={particlesRef}>
      ...
      <pointsMaterial size={0.03} color="#FFD166" transparent opacity={0.6} sizeAttenuation />
    </points>
  );
};
